				...
				<li class="nav-item <?php echo ($this->uri->segment(3) == "batch") ? "menu-open" : null; ?>">
					...
					<ul class="nav nav-treeview">
						<li class="nav-item ">
							...
							<a href="<?php echo base_url('admin/candidate/batch') ?>" class="nav-link <?php echo ($this->uri->segment(3) == 'batch' && $this->uri->segment(3) == 'batch' && $this->uri->segment(4) != 'export') ? 'active' : null ?>">
								<i class="far fa-circle nav-icon"></i>
								<p>
									Register/View Batch
								</p>
							...
							<a href="<?php echo base_url('admin/candidate/batch/export') ?>" class="nav-link <?php echo ($this->uri->segment(4) == 'export' && $this->uri->segment(4) == 'export') ? 'active' : null ?>">
								<i class="far fa-circle nav-icon"></i>
								<p>
									Export Batch
								</p>
