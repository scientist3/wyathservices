<div class="card">
  ...
  <div class="card-body">
    <div class="row">
      <div class="col-md-12">
        <form role="form" action="<?php echo site_url('../admin/candidate/course/index/' . $input->crs_id) ?>"
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <input name="crs_course_id" class="form-control <?= $input_height . ' ' . (form_error("crs_course_id") ? 'is-invalid' : null) ?>
                      " type=" text" placeholder="<?php echo ('Course ID') ?>" id="crs_course_id"
                  value="<?php echo $input->crs_course_id ?>" data-toggle="tooltip"
            ...
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <input name="crs_course_name" class="form-control <?= $input_height ?>
                      ...
                      " type=" text" placeholder="<?php echo ('Course Name') ?>" id="crs_course_name"
                  value="<?php echo $input->crs_course_name ?>" data-toggle="tooltip"
                  title="<?php echo ('Course Name'); ?>">
            ...
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <input name="crs_course_type"
                  class="form-control <?php $input_height ?> <?= form_error("crs_course_type") ? 'is-invalid' : null; ?> "
                  type="text" placeholder="<?php echo ('Course Type') ?>" id="crs_course_type"
                  value="<?php echo $input->crs_course_type ?>" data-toggle="tooltip"
                  title="<?php echo ('Course Type'); ?>">
            ...
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <input name="crs_sector_covered"
                  class="form-control <?php $input_height ?> <?= form_error("crs_sector_covered") ? 'is-invalid' : null; ?> "
                  type="text" placeholder="<?php echo ('Sector Covered') ?>" id="crs_sector_covered"
                  value="<?php echo $input->crs_sector_covered ?>" data-toggle="tooltip" title="Sector Covered">
            ...
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <input name="crs_course_fee"
                  class="form-control <?php $input_height ?> <?= form_error("crs_course_fee") ? 'is-invalid' : null; ?> "
                  type="text" placeholder="<?php echo ('Course Fee') ?>" id="crs_course_fee"
                  value="<?php echo $input->crs_course_fee ?>" data-toggle="tooltip"
                  title="<?php echo ('Course Fee'); ?>">
            ...
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <input name="crs_fee_paid_by"
                  class="form-control <?php $input_height ?> <?= form_error("crs_fee_paid_by") ? 'is-invalid' : null; ?> "
                  type="text" placeholder="<?php echo ('Fee PaidBy') ?>" id="crs_fee_paid_by"
                  value="<?php echo $input->crs_fee_paid_by ?>" data-toggle="tooltip"
                  title="<?php echo ('Fee PaidBy'); ?>">
