            ...
            <!-- ?php echo site_url('admin/gallery/create') ?> -->
              <form role="form" action="<?php echo site_url('../admin/candidate/batch/batchinsert') ?>" method="post" id="save_type_form" enctype="multipart/form-data">
                ...
                <div class="col-sm-12">
                  ...
                  <input name="batchtype" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Batch Type') ?>" id="batchtype" style="padding:18px;" value="<?=set_value('batchtype')?>" >
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="startdate" class="form-control form-control-sm" type="date" placeholder="<?php echo ('Start Date') ?>" id="startdate" style="padding:18px;" value="<?=set_value('startdate')?>" >
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="enddate" class="form-control form-control-sm" type="date" placeholder="<?php echo ('End Date') ?>" id="enddate" style="padding:18px;" value="<?=set_value('enddate')?>" >
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                  <label for="trainingcompleted"><?php echo ('Course ID'); ?></label> <small class="req"> *</small>
                ...
                <div class="col-sm-12">
                  ...
                  <input name="trainername" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Trainer Name') ?>" id="trainername" style="padding:18px;" value="<?=set_value('trainername')?>" >
                ...
                <div class="col-sm-12">
                  ...
                  <input name="trainingcenterid" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Training Center ID') ?>" id="trainingcenterid" style="padding:18px;" value="<?=set_value('trainingcenterid')?>" >
            ...
            <tbody>
                ...
                <?php foreach ($batch as $bt) { ?>
                  <tr>
                    ...
                    <td><?php echo $bt->training_completed?></td>
                    <td><?php echo $bt->assessment_completed?></td>
