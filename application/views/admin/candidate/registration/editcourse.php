        ...
        <div class="card-body">
          <div class="row">
            ...
            <!-- ?php echo site_url('admin/gallery/create') ?> -->
              <form role="form" action="<?php echo site_url('/admin/candidate/course/update') ?>" method="post" id="save_type_form" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="coursename" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Course Name') ?>" id="coursename" value="<?php echo $input[0]['course_name'] ?>" data-toggle="tooltip" title="<?php echo ('Course Name'); ?>">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="coursetype" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Course Type') ?>" id="coursetype" value="<?php echo $input[0]['course_type'] ?>" data-toggle="tooltip" title="<?php echo ('Course Type'); ?>">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="sectorcovered" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Sector Covered') ?>" id="sectorcovered" value="<?php echo $input[0]['sector_covered'] ?>" data-toggle="tooltip" title="Sector Covered">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="coursefee" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Course Fee') ?>" id="coursefee" value="<?php echo $input[0]['course_fee'] ?>" data-toggle="tooltip" title="<?php echo ('Course Fee'); ?>">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="feepaidBy" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Fee PaidBy') ?>" id="feepaidBy" value="<?php echo $input[0]['fee_paid_by'] ?>" data-toggle="tooltip" title="<?php echo ('Fee PaidBy'); ?>">
