            ...
            <!-- ?php echo site_url('admin/gallery/create') ?> -->
              <form role="form" action="<?php echo site_url('../admin/candidate/batch/batchinsert') ?>" method="post" id="save_type_form" enctype="multipart/form-data">
                ...
                <div class="col-sm-12">
                  ...
                  <input name="batchtype" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Batch Type') ?>" id="batchtype" style="padding:18px;" value="<?php echo $input[0]['batch_type'] ?>" >
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="startdate" class="form-control form-control-sm" type="date" placeholder="<?php echo ('Start Date') ?>" id="startdate" style="padding:18px;" value="<?php echo $input[0]['batch_type'] ?>" >
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="enddate" class="form-control form-control-sm" type="date" placeholder="<?php echo ('End Date') ?>" id="enddate" style="padding:18px;" value="<?php echo $input[0]['batch_type'] ?>" >
                  ...
                  <input name="courseid" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Course ID') ?>" id="courseid" style="padding:18px;" value="<?php echo $input[0]['course_id'] ?>" >
                ...
                <div class="col-sm-12">
                  ...
                  <input name="trainername" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Trainer Name') ?>" id="trainername" style="padding:18px;" value="<?php echo $input[0]['trainer_name'] ?>" >
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                  <label for="trainingcenterid"><?php echo ('Training Center ID'); ?></label> <small class="req"> *</small>
                  <input name="trainingcenterid" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Training Center ID') ?>" id="trainingcenterid" style="padding:18px;" value="<?php echo $input[0]['tc_id'] ?>" >
                  <?php echo form_error("trainingcenterid", '<span class="badge bg-danger p-1">', '</span>'); ?>
                    ...
                    <div class="col-sm-12">
                  <div class="form-group">
                  <label for="trainingcompleted"><?php echo ('Training Completed'); ?></label> <small class="req"> *</small>
                  <?php echo form_dropdown('trainingcompleted', $trainingcompleted, 0/*$user->user_role*/, 'class="form-control" id="trainingcompleted" name="trainingcompleted" '); ?>
                ...
                <div class="col-sm-12">
                  ...
                  <?php echo form_dropdown('assessmentcompleted', $assessmentcompleted, 0/*$user->user_role*/, 'class="form-control" id="assessmentcompleted" name="assessmentcompleted" '); ?>
                ...
                <div class="col-sm-12">
                  ...
                  <input name="assessmentid" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Assessment ID') ?>" id="assessmentid" style="padding:18px;" value="<?=set_value('assessmentid')?>" >
        ...
        <div class="card-body">
          <table width="100%" class="datatable_colvis table table-striped table-bordered table-hover table-sm">
            ...
            <tbody>
                          ...
                          <?php if (!empty($batch)) { ?>
                <?php $sl = 1; ?>
                <?php foreach ($batch as $bm) { ?>
                  <tr>
                    <td><?php echo $bm->bch_id?></td>
                    <td><?php echo $bm->batch_type?></td>
                    <td><?php echo $bm->start_date?></td>
                    <td><?php echo $bm->end_date?></td>
                    <td><?php echo $bm->course_id?></td>

                    <td><?php echo $bm->trainer_name?></td>
                    <td><?php echo $bm->tc_id?></td>
                    <td><?php echo $bm->training_completed?></td>
                    <td><?php echo $bm->assessment_completed?></td>
                    <td><?php echo $bm->as_id?></td>
                    <td>
    <a href="#" class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
    <!-- <a href="#" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo ('Are You Sure') ?>') "><i class="fa fa-trash"></i></a></td> -->

    <a href="<?php echo base_url("/admin/candidate/batch/batchdelete/$bm->id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo ('Are You Sure') ?>') "><i class="fa fa-trash"></i></a>
