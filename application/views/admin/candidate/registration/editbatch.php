                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="batchtype" class="form-control form-control-sm" type="text"
                        ...
                        value="<?php echo $input[0]['batch_type'] ?>">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="startdate" class="form-control form-control-sm" type="date"
                        ...
                        value="<?php echo $input[0]['start_date'] ?>">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="enddate" class="form-control form-control-sm" type="date"
                        ...
                        value="<?php echo $input[0]['end_date'] ?>">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="courseid" class="form-control form-control-sm" type="text"
                        placeholder="<?php echo ('Course ID') ?>" id="courseid" style="padding:18px;"
                        value="<?php echo $input[0]['course_id'] ?>">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="trainername" class="form-control form-control-sm" type="text"
                        ...
                        value="<?php echo $input[0]['trainer_name'] ?>">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="trainingcenterid"><?php echo ('Training Center ID'); ?></label> <small class="req">
                        *</small>
                      <input name="trainingcenterid" class="form-control form-control-sm" type="text"
                        placeholder="<?php echo ('Training Center ID') ?>" id="trainingcenterid" style="padding:18px;"
                        value="<?php echo $input[0]['tc_id'] ?>">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="<?php echo base_url("/admin/candidate/batch/batchdelete/$bm->id") ?>"
