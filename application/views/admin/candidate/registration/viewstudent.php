            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  ?>
                  <input name="fullname" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Full Name') ?>" id="fullname" style="padding:18px;" value="<?php echo $input->fullname ?>">
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  ...
                  <input type="date" name="dob" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Date od Birth ') ?>" id="dob" style="padding:18px;" value="<?php echo $input->dob ?>">
              ...
              <div class="col-sm-3">
                <div class="form-group">
                  ...
                  <input name="mobilenumber" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Mobile Number') ?>" id="mobilenumber" style="padding:18px;" value="<?php echo $input->mobile ?>">
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input name="email" class="form-control form-control-sm" type="email" placeholder="<?php echo ('Email') ?>" id="email" style="padding:18px;" value="<?php echo $input->email ?>">
              ...
              <div class="col-sm-5">
                <div class="form-group">
                  ...
                  <input name="fathersname" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Fathers/Guardian Name') ?>" id="fathersname" style="padding:18px;" value="<?php echo $input->fathersname ?>">
              ...
              <div class="col-sm-3">
                <div class="form-group">
                  ...
                  <input name="mothersname" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Mothers Name') ?>" id="mothersname" style="padding:18px;" value="<?php echo $input->mothersname ?>">
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input name="guardianname" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Guardians Name') ?>" id="guardianname" style="padding:18px;" value="<?php echo $input->guardianname ?>">
        ...
        <option value="yes">Yes</option> -->
              ...
              <div class="col-sm-3" id="typeofalternateid">
                <div class="form-group">
                  ...
                  <select name="typeofalternateid" id="typeofalternateid" class="form-control input-lg">
                    ...
                    ?>
                        <option value="<?php echo "$row" ?>" <?php if ($row == $input->typeofalternateid) echo 'selected' ?>>
                          <?php echo $row ?>
                        </option>
              ...
              <div class="col-sm-3" id="idno">
                <div class="form-group">
                  ...
                  <input name="idno" class="form-control form-control-sm" type="text" placeholder="<?php echo ('ID No.') ?>" id="idno" style="padding:18px;" value="<?php echo $input->idno ?>">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input name="permanentaddress" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Permanent Address') ?>" id="permanentaddress" style="padding:18px;" value="<?php echo $input->permanentaddress ?>">
              ...
              <div class="col-sm-3">
                <div class="form-group">
                  ...
                  <input name="permanenttehsil" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Permanent Tehsil') ?>" id="permanenttehsil" style="padding:18px;" value="<?php echo $input->permanenttehsil ?>">
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  ...
                  <input name="permanentcity" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Permanent City') ?>" id="permanentcity" style="padding:18px;" value="<?php echo $input->permanentcity ?>">
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  ...
                  <input name="permanentpincode" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Permanent PINCode') ?>" id="permanentpincode" style="padding:18px;" value="<?php echo $input->permanentpincode ?>">
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input name="permanentconstituency" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Permanent Constituency') ?>" id="permanentconstituency" style="padding:18px;" value="<?php echo $input->permanentconstituency ?>">
              ...
              <div class="col-sm-5">
                <div class="form-group">
                  ...
                  <input name="communicationaddress" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Communication Address') ?>" id="communicationaddress" style="padding:18px;" value="<?php echo $input->communicationaddress ?>">
              ...
              <div class="col-sm-3">
                <div class="form-group">
                  ...
                  <input type="text" name="communicationdistrict" id="communicationdistrict" value="<?php echo $input->communicationdistrict ?>" />
              ...
              <div class="col-sm-3">
                <div class="form-group">
                  ...
                  <input name="communicationtehsil" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Communication Tehsil') ?>" id="communicationtehsil" style="padding:18px;" value="<?php echo $input->communicationtehsil ?>">
              ...
              <div class="col-sm-3">
                <div class="form-group">
                  ...
                  <input name="communicationcity" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Communication City') ?>" id="communicationcity" style="padding:18px;" value="<?php echo $input->communicationcity ?>">
              ...
              <div class="col-sm-3">
                <div class="form-group">
                  ...
                  <input name="communicationpincode" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Communication PINCode') ?>" id="communicationpincode" style="padding:18px;" value="<?php echo $input->communicationpincode ?>">
              ...
              <div class="col-sm-3">
                <div class="form-group">
                  ...
                  <input name="communicationconstituency" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Communication Constituency') ?>" id="communicationconstituency" style="padding:18px;" value="<?php echo $input->communicationconstituency ?>">
