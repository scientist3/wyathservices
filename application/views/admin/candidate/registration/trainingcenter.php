        ...
        <div class="card-body">
          <div class="row">
            ...
            <!-- ?php echo site_url('admin/gallery/create') ?> -->
              <form role="form" action="<?php echo site_url('../admin/candidate/trainingcenter/insert') ?>" method="post" id="save_type_form" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="trainingcentername" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Training Center Name') ?>" id="trainingcentername" value="" data-toggle="tooltip" title="<?php echo ('Assessment Mode'); ?>">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="trainingcenteraddress" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Training Center Address') ?>" id="trainingcenteraddress" value="" data-toggle="tooltip" title="<?php echo ('Agency ID'); ?>">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="trainingcenterdistrict" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Training Center District') ?>" id="trainingcenterdistrict" value="" data-toggle="tooltip" title="Agency Name">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="trainingcenterpincode" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Training Center PINCode') ?>" id="trainingcenterpincode" value="" data-toggle="tooltip" title="<?php echo ('Assessor ID'); ?>">
