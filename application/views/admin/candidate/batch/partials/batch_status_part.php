      ...
      <div class="row">
        ...
        <div class="col-sm-4 col-md-3">
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              <a type="submit" class="btn btn-sm btn-primary w-100" id="mark_assessement_complete_model"
                href="<?= site_url('../admin/candidate/batch/training/' . $batch->b_id) ?>"><i class="fas fa-edit"></i>
                Update Training</a>
            </div>
          </div>
          <?php } else { ?>
          <div class="row">
            <div class="col-sm-12">
              <div class="progress mb-3 rounded">
                <div class="progress-bar bg-gray" role="progressbar" aria-valuenow="40" aria-valuemin="0"
                  aria-valuemax="100" style="width: 100%">
            ...
            <div class="col-sm-12">
              <a type="submit" class="btn btn-sm btn-primary w-100" id="mark_assessement_complete_model"
                href="<?= site_url('../admin/candidate/batch/training/' . $batch->b_id) ?>"><i class="fas fa-check"></i>
                Submit Training</a>
            </div>
          </div>
        ...
        <div class="col-sm-4 col-md-3">
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              <a type="submit" class="btn btn-sm btn-primary w-100" id="mark_assessement_complete_model"
                href="<?= site_url('../admin/candidate/assessment/index/' . $batch->b_id) ?>"><i
                  class="fas fa-edit"></i> Update Assessment</a>
            </div>
          </div>
          <?php } else { ?>
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              <a type="submit" class="btn btn-sm btn-primary w-100" id="mark_assessement_complete_model"
                href="<?= site_url('../admin/candidate/assessment/index/' . $batch->b_id) ?>"><i
                  class="fas fa-check"></i> Complete Assessment</a>
            </div>
          </div>
          <?php }  ?>
          <?php } else { ?>
        ...
        <div class="col-sm-4 col-md-3">
          ...
          <a type="submit" class="btn btn-sm btn-primary w-100" id="mark_assessement_complete_model"
            href="<?= site_url('../admin/candidate/certificate/index/' . $batch->b_id) ?>"><i class="fas fa-edit"></i>
          ...
          <a type="submit" class="btn btn-sm btn-primary w-100" id="mark_assessement_complete_model"
            href="<?= site_url('../admin/candidate/certificate/index/' . $batch->b_id) ?>"><i class="fas fa-check"></i>
        ...
        <div class="col-sm-4 col-md-3">
          ...
          <a type="submit" class="btn btn-sm btn-primary w-100" id="mark_assessement_complete_model"
            href="<?= site_url('../admin/candidate/placement/index/' . $batch->b_id) ?>"><i class="fas fa-edit"></i>
            Update Placement</a>
          <?php } else { ?>
          <!-- Traing Not Completed -->
          <div class="progress mb-3 rounded">
        ...
        <div class="col-sm-4 col-md-3">
          ...
          <a type="submit" class="btn btn-sm btn-primary w-100" id="mark_assessement_complete_model"
            href="<?= site_url('../admin/candidate/placementtracking/index/' . $batch->b_id) ?>"><i
              class="fas fa-check"></i>Submit Placement Tracking</a>
          <?php } else { ?>
          <!-- Assessment Incompleted -->
          <div class="progress mb-3 rounded">
            <div class="progress-bar bg-gray" role="progressbar" aria-valuenow="40" aria-valuemin="0"
          ...
          <a type="submit" class="btn btn-sm btn-primary w-100" id="mark_assessement_complete_model"
            href="<?= site_url('../admin/candidate/placementtracking/index/' . $batch->b_id) ?>"><i
              class="fas fa-check"></i>Complete Placement Tracking</a>
