                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="b_as_id" class="form-control <?= $input_height . ' ' . (form_error("b_as_id") ? 'is-invalid' : null); ?>" type="text" placeholder="<?php echo ('Assessment ID') ?>" id="b_as_id" value="<?php echo $input->b_as_id ?>">
                  ...
                  <div class="col-sm-12 ">
                    <div class="form-group">
                      ...
                      <?php if ($this->uri->segment(3) != "edit") { ?>
                        <button type="submit" name="save" value="add_batch" class="form-control form-control-sm btn btn-primary btn-sm pull-right checkbox-toggle"><i class="fa fa-plus"> &nbsp;<?php echo ('Save'); ?></i></button>
                      <?php } else { ?>
                        <button type="submit" name="save" value="edit_batch" class="form-control form-control-sm btn btn-warning btn-sm pull-right checkbox-toggle"><i class="fa fa-edit"> &nbsp;<?php echo ('Update'); ?></i></button>
                      <?php } ?>
                    </div>
                  </div>
                </div>
