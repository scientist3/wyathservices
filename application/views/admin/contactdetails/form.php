  ...
  <div class="row">
    ...
    <div class="col-sm-12">
      <?php if ($this->session->flashdata('message') != null) {  ?>
        <div class="alert <?= $this->session->flashdata('class_name') ?> alert-dimissible">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="cont_address" class="form-control form-control-sm" type="text" placeholder="<?php echo ('Address') ?>" id="cont_address" value="<?php echo $input->cont_address; ?>" data-toggle="tooltip" title="<?php echo ('Address'); ?>">
                      ...
                      <div class="form-check row form-inline form-control-sm">
                        <div class="col-6 form-inline">
                          <label class=" radio-inline">
                            <input type="radio" name="cont_status" value="1" <?= ($input->cont_status == '1') ? 'checked' : null; ?> data-toggle="tooltip" title="Active status">&nbsp;
                            <?php echo ('Active') ?>
                          </label>
                        </div>
                        <div class="col-6 form-inline">
                          <label class=" radio-inline">
                            <input type="radio" name="cont_status" value="0" <?= ($input->cont_status == '0') ? 'checked' : null; ?> data-toggle="tooltip" title="Discdled status"> &nbsp;<?php echo ('Inactive') ?>
                          </label>
                        </div>
                        <br>
                      </div>
