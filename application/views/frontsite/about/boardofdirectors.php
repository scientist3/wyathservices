		...
		<div class="container">
			...
			<div class="c-content-team-1-slider" data-slider="owl" data-items="3">
				...
				<div class="row" style="display: flex;flex-wrap: wrap;">
					<?php if (valArr($boardmembers)) : ?>
						<?php foreach ($boardmembers as $key => $member) : ?>
							<!-- Director Start-->
							<div class="col-md-4">
								<div class="c-content-person-1 c-bordered c-shadow">
									<div class="c-caption c-content-overlay">
										...
										<img class="c-overlay-object img-responsive" src="<?= !empty($member->bm_img_path) ? base_url($member->bm_img_path) : '#'; ?>" alt="">
									</div>
									<div class="c-body">
										<div class="c-head">
