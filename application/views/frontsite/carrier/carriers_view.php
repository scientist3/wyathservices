            ...
            <table class="table table-hover" cellspacing="1" cellpadding="6" rules="all" border="1" id="">
              <tbody>
                <tr align="center">
                  ...
                  <th scope="col" style="width:50%;">Contents</th>
                  <th scope="col" style="width:5%;">Link</th>
                  <th scope="col" style="width:5%;">Download</th>
                </tr>
                <?php if (valArr($carriers)) :
                  $s = 0; ?>
                  <?php foreach ($carriers as $event_id => $new) :
                    $s++; ?>
                    <tr>
                      <td align="center">
                        <span><?= $s; ?></span>
                      ...
                      <td class="sp">
                        <?php if (!empty($new->news_doc_link)) { ?>
                          <a class="btn c-btn-red-2 c-btn-uppercase c-btn-bold c-btn-border-1x" href="<?php echo base_url($new->news_doc_link); ?>">Download</a>
                        <?php  } ?>
                      </td>
                    </tr>
                  <?php endforeach; ?>
